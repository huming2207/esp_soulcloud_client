...
namespace soulcloud
{
    esp_err_t command_registry::register_command(const char *name, command_handler_t handler)
    {
    ...
    command_registry::recent_entry *command_registry::recent_find(const uint8_t *id)
    {
    ...
    void command_registry::recent_put(const uint8_t *id, int32_t code)
    {
    ...
    int32_t command_registry::dispatch(const uint8_t *payload, size_t len,
